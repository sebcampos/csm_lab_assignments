...
# todo Jacob define a function to get a guessing_range


# todo Jacob define a function to check guessing_range
...
if __name__ == "__main__":
    ...
    # todo Jacob collect desired_range
    # todo Jacob check that desired_range is acceptable
    # todo Jacob while desired range is not acceptable ask for input again
